...
In this case, if you do not pass any argument to this function, it will return you two |Numba| callables:
...
Finally, one may be interested to get a string representation of the tendencies and the Jacobian matrix, instead of callables.
